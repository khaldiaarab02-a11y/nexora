    ...
    <section className="relative overflow-hidden bg-[#fbfaff]">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-8 pt-12 sm:px-6 sm:pt-16 lg:px-8 lg:pt-20">
        <div className="landing-hero-visual relative overflow-hidden rounded-[30px] border border-violet-100/80 bg-white shadow-[0_35px_100px_rgba(76,29,149,0.10)] sm:rounded-[38px]">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-white via-white/95 to-white/5 sm:via-white/90" aria-hidden="true" />
          <div className="relative z-10 flex min-h-[560px] items-center px-6 py-14 sm:min-h-[600px] sm:px-10 lg:min-h-[650px] lg:px-14">
            <div className="max-w-[500px]">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <a href="#features" className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-zinc-200 bg-white/90 px-6 text-sm font-bold text-zinc-800 transition hover:border-zinc-300 hover:bg-white">
                  {t.landing.explore}
                </a>
              </div>
