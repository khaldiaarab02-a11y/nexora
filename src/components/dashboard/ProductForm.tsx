...
export default function ProductForm() {
  ...
  return (
    <div className="w-full max-w-2xl rounded-3xl border border-zinc-200 bg-white p-7 shadow-sm" dir="rtl">
      <div className="mb-7">
        ...
        <p className="mt-2 text-sm text-zinc-500">
          أضف المنتج الأساسي إلى متجرك. الصور والتصنيفات سنضيفها في المرحلة التالية.
        </p>
      </div>
...
const inputClass =
  "w-full rounded-xl border border-zinc-300 px-4 py-3 outline-none focus:border-zinc-900";