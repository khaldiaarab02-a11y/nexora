    ...
    <main dir={dir} className="min-h-screen bg-zinc-50 py-8">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="flex items-start justify-between gap-4">
          <div><p className="text-sm text-zinc-500">Nexora</p><h1 className="mt-1 text-3xl font-bold">الاشتراك</h1><p className="mt-2 text-sm text-zinc-500">اختاري الخطة ثم أرسلي إثبات الدفع للمراجعة.</p></div>
