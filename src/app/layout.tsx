...
import { LANGUAGES, DEFAULT_LANGUAGE, type Language } from "@/i18n/config";
...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  const initialLanguage: Language = storedLanguage && LANGUAGES.includes(storedLanguage as Language) ? storedLanguage as Language : DEFAULT_LANGUAGE;
